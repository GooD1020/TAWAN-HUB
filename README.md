...
function library:AddWindow(text,keybind)
    ...
    NameHub2.Text = "HUB"
    NameHub2.TextColor3 = Color3.fromRGB(0,255,0)
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            function main:AddSeperator(text)
                ...
                Sep3.BackgroundColor3 = Color3.fromRGB(0,255,0)
            ...
            function main:AddTextbox(text,disappear,callback)
                ...
                TextboxLabel.TextColor3 = Color3.fromRGB(0,255,0)
            ...
            function main:AddToggle(text,config,callback)
                ...
                tgleimg.BackgroundColor3 = Color3.fromRGB(0,255,0)
...
local win = library:AddWind("TAWAN ")

local MainTab = win:AddTab("หน้าหลัก")
local AutoFarm = MainTab:AddPage()
local S = MainTab:AddPage()
local MainTabm = win:AddTab("ออโต้ทำของ+สถาน")
local Main = MainTabm:AddPage()
local Stats = MainTabm:AddPage()
local MainTabn = win:AddTab("วาป+ลงดัน")
local Island = MainTabn:AddPage()
local Dungeon = MainTabn:AddPage()
local MainTabnn = win:AddTab("ล่าฆ่าหัว")
local Player = MainTabnn:AddPage()
local nnn = MainTabnn:AddPage()

AutoFarm:AddToggle("Auto SetSpawn Point",true,function(x)
    _G.Set = x
end)
...
AutoFarm:AddToggle("AutoFarm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
  ...
  AutoFarm:AddSeperator("AutoMoJi")
    
      local MobKilled = AutoFarm:AddLabel("Killed")
    ...
    AutoFarm:AddToggle("AutoMoJi",_G.AutoDoughtBoss,function(value)
    ...
    local SelectWeapons = AutoFarm:AddDropdown("SelectWeapons",WeaponList,function(value)
        _G.SelectWeapon = value
    end)
    
    AutoFarm:AddToggle("Refresh Weapon",function()
        SelectWeapons:Clear()
        for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do  
...
AutoFarm:AddSeperator("Mastery")
    
    AutoFarm:AddToggle("Auto Farm BF Mastery",_G.AutoFarmFruitMastery,function(value)
    ...
    AutoFarm:AddToggle("Auto Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
    ...
    spawn(function()
        ...
        _G.Kill_At = 25
    AutoFarm:AddSlider("Kill At %",1,100,25,function(value)
        _G.Kill_At = value
    end)
    
S:AddToggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
S:AddToggle("FastAttack",true,function(value)
_G.FastAttack = value
end)
...
S:AddToggle("FastAttack2",true,function(value)
...
S:AddToggle("จอขาว",false,function(vu)
_G.WhiteScren = vu
end)
    ...
    S:AddSeperator("Mastery Skill Settings")
    
    S:AddToggle("Skill Z",true,function(value)
        _G.SkillZ = value
    end)
    
    S:AddToggle("Skill X",true,function(value)
        _G.SkillX = value
    end)
    
    S:AddToggle("Skill C",true,function(value)
        _G.SkillC = value
    end)
    
    S:AddToggle("Skill V",true,function(value)
        _G.SkillV = value
    end)
--Auto
    Main:AddLabel("Auto FN")

    Main:AddToggle("Auto Superhuman",false,function(vu)
    _G.Superhuman = vu
    end)
    spawn(function()
            while wait() do wait()
    ...
    if Old_World or Three_World then
        Main:AddToggle("Auto Second World",false, function(vu)
    ...
    if New_World then
    Main:AddToggle("Auto Third Sea",false, function(vu)
      ...
      Main:AddSeperator("ลงดัน ก้าวหน้า")
    
    Main:AddToggle("ออโต้ลงดันก้าวหน้า",_G.AutoAdvanceDungeon,function(value)
    ...
    Main:AddSeperator("ดาบบิกมัม")
    
    Main:AddToggle("ออโต้ดาบบิกมัม",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:AddToggle("ออโต้ดาบบิกมัมHop",_G.AutoBudySwordHop,function(value)
    ...
    Main:AddToggle("ออโต้ตีบอสอีรีท",_G.AutoElitehunter,function(value)
    ...
    Main:AddToggle("ออโต้ตีบอสอีรีท ออก",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    Main:AddSeperator("เคียว")
    
    Main:AddToggle("ออโต้เคียว",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    Main:AddToggle("ออโต้เคียว ออก",_G.AutoFarmBossHallowHop,function(value)
    ...
    Main:AddSeperator("ดาบหำจิ๋ว")
    
    Main:AddToggle("ออโต้ ดาบหำจิ๋ว",_G.AutoDarkDagger,function(value)
    ...
    Main:AddToggle("ออโต้ดาบหำจิ๋ว Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    Main:AddSeperator("แก้วหงส์")
    
    Main:AddToggle("ออโต้แก้วหงส์",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:AddToggle("แก้วหงส์ออด",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    local BoneFarm = Main:AddToggle("ออโต้ ฟาร์ม กระดูก",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main:AddToggle("สุ่มเซอร์ไพรส์อัตโนมัติ",_G.Auto_Random_Bone,function(value)
    ...
    Main:AddToggle("ออโต้ ฟาร์ม หาขี่สังเกต",_G.AutoObservation,function(value)
    ...
    Main:AddToggle("ออโต้ ฟาร์ม หาขี่สังเกต ออก",_G.AutoObservation_Hop,function(value)
    ...
    Main:AddSeperator("ดาบเเช็ง")
    
    Main:AddToggle("ออโต้ แช็ง",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    Main:AddToggle("ออโต้ แช็ง ออก",_G.AutoSaber_Hop,function(value)
    ...
    Main:AddToggle("ดาบโซโล")
    
    Main:AddToggle("ออโต้ ดาบโซโล",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:AddToggle("ออโต้ ดาบโซโล ออก",_G.AutoBuyLegendarySword_Hop,function(value)
    ...
    Main:AddToggle("ทำดาบ twoชี้ตะ",_G.AutoHolyTorch,function(value)
...
--State
    Stats:AddLabel(" Stats FN")
    Stats:AddToggle("Melee", _G.Melee, function(vu)
        _G.Melee = vu
    end)
    Stats:AddToggle("Defense", _G.Defense, function(vu)
        _G.Defense = vu
    end)
    Stats:AddToggle("Sword", _G.Sword, function(vu)
        _G.Sword = vu
    end)
    Stats:AddToggle("Gun", _G.Gun, function(vu)
        _G.Gun = vu
    end)
    Stats:AddToggle("Blox Fruit", _G.Fruit, function(vu)
        _G.Fruit = vu
    end)
    Stats:AddLabel("Kaitan Stats")
    Stats:AddToggle("Kaitan Stats",false,function(vu)
        _G.Melee = vu
        _G.Defense = vu
    end)
    ...
    Dungeon:AddToggle("คิลออร่า + เปลี่ยน เกาะ",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:AddToggle("ผลตื่นแบบ ออโต้",_G.Auto_Awakener,function(value)
    ...
    Dungeon:AddToggle("กันที่จะลง",_G.AutoSelectDungeon,function(value)
    ...
    Dungeon:AddToggle("ซื้อชิป 1",_G.AutoBuyChip,function(value)
    ...
    Dungeon:AddButton("ซื้อชิป",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dungeon:AddToggle("ออโต้เริ่มดัน",_G.Auto_StartRaid,function(value)
    ...
    Dungeon:AddButton("เริ่มดัน",function()
        if New_World then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif Three_World then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Dungeon:AddButton("เปลี่ยนเกราะ",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    ...
    local SelectedPly = Player:AddDropdown("Select Players",Playerslist,function(value)
        _G.SelectPly = value
    end)
    ...
    Player:AddToggle("Aimbot Gun", false, function(vu)
        Aimbot = vu
    end)
    
    Player:AddToggle("Aimbot Skill ", false, function(vu)
        AimSkillNearest = vu
    end)
    ...
    Player:AddToggle("Spectate Player",false,function(value)
        SpectatePlys = value
    ...
    Player:AddToggle("Teleport To Player",false,function(value)
